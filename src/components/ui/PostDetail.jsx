...
const PostDetail = () => {
    ...
    const fetchPostById = async () => {
        const post = await axios.get(`${process.env.REACT_APP_BACKEND_URL}/api/v1/posts/${postId}`);
    ...
    const handleDelete = async () => {
        try {
            await axios.delete(`${process.env.REACT_APP_BACKEND_URL}/api/v1/posts/${postId}`, config);
